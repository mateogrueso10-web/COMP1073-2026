...
let products = ["Bread:2.99", "Milk:3.49", "Eggs:4.99", "Butter:5.49", "Cheese:6.99"];
...
products.forEach((product) => {
	...
	itemRow[itemCounter].innerHTML = itemDetail[itemCounter];
	productList.append(itemRow[itemCounter]);
	itemCounter ++;
});
...
totalData.textContent = `Total: $${invoiceTotal.toFixed(2)}`;
